...
%>
	<table>
		<tr>
			<td>
				<input id="tb_id" type="text" style="width:120px">
			</td>
			<td rowspan="2">
				<a id="btn" href="javascript:login()" class="easyui-linkbutton" style="width:60px; height:60px;">
					로그인
				</a>
			</td>
		</tr>
		<tr>
			<td>
				<input id="pb_pw" type="text" style="width:120px">
			</td>
		</tr>
