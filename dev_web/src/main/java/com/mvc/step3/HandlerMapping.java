...
public class HandlerMapping {
	 ...
	 * @param req -> 1-2와 1-3에서와는 다르게 Controller 인터페이스를 implements하지 않고 있다.
	 * @param res -> 그렇다면 req, res를 어디서 전달 받는 걸까?
	 * HttpSevlet을 상속받아서 톰캣서버가 제공하는 요청객체와 응답객체를 사용함
	 * @param String/ModelAndView -> 유지를 위한 req.setAttribute()를 대신하는 클래스로 설계함
	 */
